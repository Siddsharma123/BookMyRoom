...
namespace BookYourResidency.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<BookYourResidencyDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("BookYourResidencyDB")));
